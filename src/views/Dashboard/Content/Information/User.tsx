								...
								titleUser.map((title, index) => {
									return (
										<div style={{ width: '100%', display: 'flex', justifyContent: 'space-evenly', marginTop: 20 }}>
											<div style={{ width: '38%' }}>
												<Text style={{ fontSize: 16, fontWeight: 600, color: '#282739' }}>
													{
														title.titleTextOne
													}
												</Text>
												<Input bordered={false} style={{ marginTop: 12, height: 44, background: '#EAEAEC', color: '#535261' }} placeholder={title.titleInputOne} />
											</div>
											<div style={{ width: '38%' }}>
												<Text style={{ fontSize: 16, fontWeight: 600, color: '#282739' }}>
													{
												...
												<Input bordered={false} style={{ marginTop: 12, height: 44, background: '#EAEAEC', color: '#535261' }} placeholder={title.titleInputTwo} />
											</div>
										</div>
									)
								})

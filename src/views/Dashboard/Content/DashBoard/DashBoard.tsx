	...
	return (
		<ThemeProvider value={themeName}>
			<div style={{ width: '100%', height: '80vh' }}>
				<Row>
					<Col flex={3} style={{ height: '80vh', padding: '45px 24px 0px 24px' }}>
						<div style={{ width: '100%', paddingLeft: '46px' }}>
							<Title level={3} style={{ fontSize: 24, fontWeight: 700, color: theme.textColorOrange }}>Biểu đồ cấp số</Title>
							<div>
										...
										<Col span={5}>
											...
											>
												<div style={{ display: 'flex', justifyContent: 'space-between' }}>
													...
													<div
														style={{ lineHeight: '12px', marginTop: '10px', height: 22, backgroundColor: 'rgb(255, 218, 188)', paddingTop: '4px', paddingLeft: '6px', paddingRight: '8px', borderRadius: '10px' }}
													>
										...
										<Col span={5}>
											...
											>
												<div style={{ display: 'flex', justifyContent: 'space-between' }}>
													...
													<div
														style={{ lineHeight: '12px', marginTop: '10px', height: 22, backgroundColor: 'rgb(255 201 201)', paddingTop: '4px', paddingLeft: '6px', paddingRight: '8px', borderRadius: '10px' }}
													>
							...
							<div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
								...
								<div style={{ display: 'flex', justifyContent: 'space-between' }}>
									<div>
										<Title style={{ fontSize: 16, fontWeight: 600, marginTop: '12px' }}>Xem theo</Title>
									</div>
									<div>
										{/* Todo: Need fix this */}
					...
					<Col flex={2} style={{ height: '80vh', paddingTop: '45px' }}>
						<div>
							<Title  style={{ fontWeight: 700, fontSize: 24, color: theme.textColorOrange }}>
								Tổng quan
							</Title>
